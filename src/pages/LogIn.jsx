      ...
      try {
        ...
        if (result.success) {
          ...
          const profileResponse = await fetch(
            `http://localhost:5000/api/auth/profile/get?email=${email}`
          );
          ...
          setError({
            ...error,
            general: result.message || "Login failed. Try again.",
          });
        }
      } catch (err) {
        setError({
        ...
        <div className="row w-100">
          ...
          <div className="col-lg-6 col-md-6 col-12 d-flex flex-column justify-content-center px-4">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="input-group">
                  ...
                  >
                    <i
                      ...
                      style={{ fontSize: "1.2rem", color: "#B8860B" }}
                    ></i>
                  </button>
                </div>
                {error.password && (
              ...
              {error.general && (
                <div className="text-danger small mt-2">{error.general}</div>
              )}
