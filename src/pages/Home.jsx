...
const Home = () => {
  ...
  const userRole = localStorage.getItem("role"); // ✅ Added role check
  const isLoggedIn = !!token;

  // ✅ Handle Restricted Navigation
  const handleRestrictedNavigation = (e, route, requiredRole) => {
    if (!isLoggedIn) {
      e.preventDefault();
      ...
      e.preventDefault();
      alert(`You must log in as a ${requiredRole} to access this page.`);
    } else {
      navigate(route);
    }
  };
      ...
      <div className="container-fluid home-container py-5">
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 text-center text-lg-start ">
            ...
            <h2 className="text-secondary fw-semibold ms-lg-5">
              for Home & Online Tuitions
            </h2>
            <p className="text-muted mt-3">
              <i className="bi bi-geo-alt-fill text-primary ms-lg-5"></i> Find
              the Right Tutor in Your Area
            </p>

            {/* ✅ Find a Tutor Button (Only for Students) */}
            <button
              onClick={(e) =>
                handleRestrictedNavigation(e, "/TutorRequest", "student")
              }
          ...
          <div className="col-lg-6 d-flex flex-column justify-content-center align-items-center">
            <div className="text-muted">
              ...
              <div className="mt-2 p-4">
                ...
                We often have <strong className="text-danger">500+</strong> open
                home tuition jobs that are genuine and{" "}
                <strong className="text-danger">100% verified</strong>. Whether
                you are starting your career as a tuition teacher or an expert
                in your field, we can help you find your next big tuition job.
              </div>
            </div>

            {/* ✅ Search Tuition Button (Only Accessible to Tutors) */}
            <button
              onClick={(e) =>
                handleRestrictedNavigation(e, "/TutionJob", "tutor")
              }
